...
const Intro = () => {
  return (
    <section className='mb-28 max-w-[50rem] text-center sm:mb-0 scroll-mt-32' id='home'>
      ...
      >
        <Link href="#contact" className='bg-orange-600 group cursor-pointer text-white px-7 py-3 flex items-center gap-2 rounded-full outline-none focus:scale-110 hover:scale-110 hover:bg-orange-400 active:scale-100 transition' >
